...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-backgorund">
       ...
       <main class="container mx-auto flex max-w-6xl">
        <div class="mr-8">
            <div class="bg-white border border-blue-500 rounded-xl mt-16" style=" border-image-source: linear-gradient(to bottom, rgba(50, 138, 241, 0.22), rgba(99, 123, 255, 0));
            ...
            <div class="text-center px-6 py-2 pt-6 ">
                ...
                <p class="text-xs mt-4">Let us know what you wold like and we'll take a look over!</p>
                <form action="#" method="POST" class="space-y-4 px-2 py-6">
                    <div>
                        <input type="text" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 border-none text-sm" placeholder="Your idea">
                    </div>
                    <div>
                        <select name="category_add" id="category_add" class="w-full text-sm rounded-xl px-4 py-2 border-none bg-gray-100" >
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        <button
                            type="button"
                            class="
                            flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200
                            font-bold rounded-xl border border-gray-200 hover:border-gray-400 hover:bg-gray-300
                            transition duration-150 ease-in px-6 py-3
                            ">
                            <svg class="h-4 w-4 text-gray-600 transform-gpu -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    type="submit"
                    class="
                    flex items-center justify-center w-1/2 h-11 text-xs bg-blue-500 text-white
