                ...
                <div class=" w-full mx-4 ">
                    ...
                    <div class="flex items-center justify-between mt-6">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button class="bg-gray-100 rounded-full w-20 h-7 text-gray-500 px-3 py-2 border hover:bg-gray-200 transition-duration-150 ease-in relative ">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-8 absolute top-0 flex items-center ml-3 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <ul class="absolute w-44 text-left font-semibold bg-white shadow-lg py-3 rounded-xl ml-12">
                                          ...
                                          <li><a href="#" class="hover:bg-gray-100 transition-duration-150 ease-in py-3 px-5 block"> Delete Post </a>  </li>
                                      </ul>
                                </button>
                            </div>
                    </div>
